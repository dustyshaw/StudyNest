  ...
  return (
    <>
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-navy-100 rounded-lg sm:hidden hover:bg-navy-100 focus:outline-none focus:ring-2 focus:ring-navy-200 "
      >
