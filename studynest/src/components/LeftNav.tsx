  ...
  return (
    <>
      {/* <button
        ...
        type="button"
        className="hidden inline-flex items-center p-2 mt-2 ms-3 text-sm text-navy-100 rounded-lg sm:hidden hover:bg-navy-100 focus:outline-none focus:ring-2 focus:ring-navy-200 "
      >
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-navy-700">
          <ul className="space-y-2 font-medium">
            ...
            <Link to={"/"}>
              ...
              >
                <svg
                  className="w-5 h-5 text-gray-100 transition duration-75  group-hover:text-navy-900"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 22 21"
